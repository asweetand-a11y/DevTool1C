...
export class VRunnerManager {
	 ...
	 * 
	 * Путь берется из настроек Cursor/VS Code (1c-dev-tools.vrunner.path).
	 ...
	 * 
	 * Путь берется из настроек VS Code (1c-dev-tools.vrunner.initSettingsPath).
	 ...
	 * 
	 * Путь берется из настроек VS Code (1c-dev-tools.opm.path).
	 * По умолчанию: 'opm'
	 * 
	 ...
	 * 
	 * Путь берется из настроек VS Code (1c-dev-tools.paths.src).
	 * По умолчанию: 'src/cf'
	 * 
	 ...
	 * 
	 * Путь берется из настроек VS Code (1c-dev-tools.paths.build).
	 ...
	 * 
	 * Путь берется из настроек VS Code (1c-dev-tools.paths.epf).
	 ...
	 * 
	 * Путь берется из настроек VS Code (1c-dev-tools.paths.erf).
	 ...
	 * 
	 * Путь берется из настроек VS Code (1c-dev-tools.paths.cfe).
	 ...
	 * @param options.name - Имя терминала (по умолчанию '1C Dev Tools')
	...
	public executeOneScriptInTerminal(
		...
		const terminal = vscode.window.createTerminal({
			name: options?.name || '1C Dev Tools',
			cwd: cwd,
	 ...
	 * 
	 * Путь берется из настроек VS Code (1c-dev-tools.onescriptPath).
